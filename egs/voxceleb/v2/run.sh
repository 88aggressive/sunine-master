...
SPEAKER_TRAINER_ROOT=/home/code/sunine
voxceleb1_root=//home/mnt/database/sre/voxceleb/1/test/wav
voxceleb2_root=/home/mnt/database/sre/voxceleb/vox2_wav/dev/aac
#sitw_dev_root=/nfs/data/sid/SITW/dev
#sitw_eval_root=/nfs/data/sid/SITW/eval
#musan_path=/nfs/data/musan
#rirs_path=/nfs/data/RIRS_NOISES
...
if [ $stage -le 2 ];then
  ...
  python3 local/format_trials_voxceleb1.py \
          ...
          --src_trl_path data/trials/veri_test2.txt \
          --dst_trl_path data/trials/veri_v1.txt
...
if [ $stage -le 3 ];then
  ...
  CUDA_VISIBLE_DEVICES=$cuda_device python3 -W ignore $SPEAKER_TRAINER_ROOT/main.py \
          ...
          --trials_path data/trials/veri_v1.txt \
          --n_mels 80 \
...
if [ $stage -eq 5 ];then
  # An example of the C-P Map on VoxCeleb1-E trials against v1/.
  python3 $SPEAKER_TRAINER_ROOT/trainer/metric/compute_trial_config.py \
          --mode 1 \
          --input_scores_ref ../v1/scores/VoxCeleb1-Clean.txt.foo \
...
#          --mode 1 \
#          --metric eer \
#          --input_configs_ref ../v1/scores/VoxCeleb1-E-Clean.eer.cfg \
#          --input_configs_test VoxCeleb1-E-Clean.eer.cfg \
#          --scale 20 \
#          --savedir cpmap/
#
...
#          --mode 1 \
#          --metric dcf \
#          --input_configs_ref ../v1/scores/VoxCeleb1-E-Clean.dcf.cfg \
#          --input_configs_test VoxCeleb1-E-Clean.dcf.cfg \
#          --scale 20 \
#          --savedir cpmap/
fi
